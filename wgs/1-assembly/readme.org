...
- Create combined FASTQ file
  ...
  #+begin_src sh :tangle 1-assemble/kk/1-combine.sh
...
- Assemble with hifiasm
  #+begin_src sh :tangle 1-assemble/kk/2-run.sh
ROOT=$(git rev-parse --show-toplevel)
...
#+begin_src perl :tangle 6-ncbi/remove.contam.pl
...
#+begin_src perl :tangle 6-ncbi/seq-lengh.pl
